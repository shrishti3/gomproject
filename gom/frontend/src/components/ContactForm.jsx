...
const ContactForm = () => {
  ...
  const selectOptions = [
    { label: 'Budget Range', name: 'budget', options: ['< $50K', '$50K - $500K', '$500K - $1M', '> $1M'] },
    { label: 'Timeline', name: 'timeline', options: ['ASAP', '1-3 months', '3-6 months', '6+ months'] },
  ];
          ...
          >
            ...
            >
              ...
              >
                ...
                {selectOptions[1].options.map((opt) => (
                  <option key={opt} value={opt}>
                    {opt}
                  </option>
                ))}
